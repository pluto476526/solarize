...
class LocationScorer:
    ...
    def calculate_location_score(self):
        ...
        annual_production_score = min(
            100, (self.base_data["annual_total"] / 5000) * 100
        )
        ...
        peak_hours_production = self.hourly_data[
            self.hourly_data["hour"].between(12, 18)
        ]["ac_power"].sum()
        peak_alignment_score = (
            peak_hours_production / self.base_data["annual_total"]
        ) * 100
