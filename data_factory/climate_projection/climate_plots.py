...
def create_temperature_daily_plot(raw_data, insights):
    ...
    temp_pivot = temp_data.pivot_table(index='date', columns='parameter', values='value').reset_index()
...
def create_precipitation_daily_plot(raw_data, insights):
    ...
    fig = go.Figure()
    fig.add_trace(go.Scatter(
        x=hydro_data['date'], y=hydro_data['value'],
...
def create_irrigation_seasonal_pattern_plot(balance_df, insights):
    ...
    return fig.to_html(include_plotlyjs=False, div_id="irrigation_seasonal_pattern_plot")
...
def create_irrigation_deficit_distribution_plot(balance_df, insights):
    ...
    return fig.to_html(include_plotlyjs=False, div_id="irrigation_deficit_distribution_plot")
...
def generate_all_plots(data_dict):
    ...
    # Solar plots
    plots['solar_daily'] = create_solar_daily_plot(data_dict['raw_data'], data_dict['insights'])
    plots['solar_monthly'] = create_solar_monthly_plot(data_dict['insights'])
    plots['solar_annual'] = create_solar_annual_plot(data_dict['raw_data'], data_dict['insights'])
    
    # Temperature plots
    plots['temperature_daily'] = create_temperature_daily_plot(data_dict['raw_data'], data_dict['insights'])
    plots['temperature_climatology'] = create_temperature_climatology_plot(data_dict['insights'])
    plots['temperature_distribution'] = create_temperature_distribution_plot(data_dict['raw_data'], data_dict['insights'])
    
    # Hydrological plots
    plots['precipitation_daily'] = create_precipitation_daily_plot(data_dict['raw_data'], data_dict['insights'])
    plots['humidity_daily'] = create_humidity_daily_plot(data_dict['raw_data'], data_dict['insights'])
    plots['precipitation_climatology'] = create_precipitation_climatology_plot(data_dict['insights'])
    plots['humidity_climatology'] = create_humidity_climatology_plot(data_dict['insights'])
    
    # Wind plots
    plots['wind_daily'] = create_wind_daily_plot(data_dict['raw_data'], data_dict['insights'])
    plots['wind_climatology'] = create_wind_climatology_plot(data_dict['insights'])
    plots['wind_annual'] = create_wind_annual_plot(data_dict['raw_data'], data_dict['insights'])
    plots['wind_distribution'] = create_wind_distribution_plot(data_dict['raw_data'], data_dict['insights'])
    
    # Agricultural water plots
    plots['et0_cwr_daily'] = create_et0_cwr_daily_plot(data_dict['et0_df'], data_dict['cwr_df'], data_dict['insights'])
    plots['water_balance_monthly'] = create_water_balance_monthly_plot(data_dict['balance_df'], data_dict['insights'])
    ...
    plots['irrigation_need_monthly'] = create_irrigation_need_monthly_plot(data_dict['balance_df'], data_dict['insights'])
    plots['irrigation_deficit_annual'] = create_irrigation_deficit_annual_plot(data_dict['balance_df'], data_dict['insights'])
    plots['irrigation_seasonal_pattern'] = create_irrigation_seasonal_pattern_plot(data_dict['balance_df'], data_dict['insights'])
    plots['irrigation_deficit_distribution'] = create_irrigation_deficit_distribution_plot(data_dict['balance_df'], data_dict['insights'])
