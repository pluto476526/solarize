...
class EnvironmentalAnalyzer:
    ...
    def __init__(self, simulation_data: Dict, environmental_params: Optional[Dict] = None):
        """
    ...
    def calculate_carbon_reduction(self) -> Dict:
        ...
        gross_co2_reduction = self.annual_energy_kwh * self.params['grid_carbon_intensity']
        solar_lifecycle_emissions = self.annual_energy_kwh * self.params['lifecycle_carbon_intensity']
        net_co2_reduction = gross_co2_reduction - solar_lifecycle_emissions
        
        # Calculate environmental equivalents
        equivalent_gallons_gasoline = net_co2_reduction / self.params['co2_per_gallon_gasoline']
        equivalent_cars_removed = net_co2_reduction / self.params['annual_co2_per_car']
        equivalent_trees_planted = net_co2_reduction / self.params['co2_sequestered_per_tree']
        equivalent_miles_driven = net_co2_reduction / self.params['co2_per_mile_avg_car']
    ...
    def calculate_water_savings(self) -> Dict:
        ...
        water_saved_thermo = self.annual_energy_kwh * self.params['water_use_thermo_kwh']
        ...
        return {
            ...
            'net_water_savings_gallons': round(net_water_savings * 264.172, 1),  # Convert to gallons
        }
    ...
    def calculate_lifetime_environmental_impact(self) -> Dict:
        ...
        lifetime_co2_reduction = cumulative_energy * (
            self.params['grid_carbon_intensity'] - self.params['lifecycle_carbon_intensity']
        )
        ...
        return {
            ...
            'equivalent_lifetime_cars_removed': round(
                lifetime_co2_reduction / self.params['annual_co2_per_car'] / system_lifetime_years, 1
            ),
        }
    ...
    def calculate_score(self) -> Dict:
        ...
        carbon_score = min(100, co2_per_kw / 500 * 100)  # Scale based on 500 kg/kW-year target
        ...
        total_pollutant_reduction = (
            ...
            air_pollution_reduction['nitrogen_oxides_reduction_kg'] * 10 +  # Weight NOx more heavily
            air_pollution_reduction['particulate_matter_reduction_kg'] * 100  # Weight PM2.5 most heavily
        )
