...
urlpatterns = [
    ...
    path("Pspec-sheet-modelling/", views.spec_sheet_modelling_view, name="spec_sheet_modelling"),
    ...
    path("temperature-effects/", views.temperature_effects_view, name="temperature_effects"),
    path("system-sizing/", views.system_sizing_view, name="system_sizing"),
    path("pvlib-report/", views.pvlib_report_view, name="pvlib_report"),
