...
class FinancialAnalyzer:
    ...
    def calculate_simple_payback(self) -> float:
        ...
        incentive_adjustment = (
            self.params["tax_credit_rate"] + self.params["state_rebate"]
        )
    ...
    def calculate_net_present_value(self) -> float:
        ...
        for year in range(1, self.params["system_lifetime_years"] + 1):
            ...
            operational_costs = (
                self.params["annual_maintenance_cost"]
    ...
    def calculate_levelized_cost_of_energy(self) -> float:
        ...
        for year in range(1, self.params["system_lifetime_years"] + 1):
            ...
            discounted_energy = year_energy / (
                (1 + self.params["discount_rate"]) ** year
            )
    ...
    def calculate_score(self) -> Dict:
        ...
        payback_score = (
            max(0, min(100, (20 - simple_payback) * 10))
        ...
        npv_score = (
            max(0, min(100, npv / self.total_system_cost * 100)) if npv > 0 else 0
        )
        ...
        lcoe_score = (
            max(0, min(100, (0.30 - lcoe) * 500)) if lcoe != float("inf") else 0
        )
        ...
        return {
            ...
            "key_metrics": {
                ...
                "annual_energy_savings": round(
                    self.annual_energy_kwh * self.params["electricity_rate"], 2
                ),
            },
            "component_scores": {
